// addmult5: CSA+CLA sum, Booth for square, CSLA shift-add for 4th power.
module addmult5 (
    input  [31:0] a,
    input  [31:0] b,
    input  [31:0] c,
    ...
    am5_adder_cla #(34) u_add_abc (
        .a({2'b00, sum_csa}),
        .b({1'b0, carry_csa, 1'b0}),
        .cin(1'b0),
        .sum(sum_abc),
        .cout(cout_abc)
    );
    ...
    am5_mult_booth #(34, 34) u_mul2 (
        .a(sum_abc),
        .b(sum_abc),
        .product(t2)
    );

    am5_mult_shift_add_csla #(68, 68) u_mul4 (
        .a(t2),
        .b(t2),
        .product(t4)
    );
...
module am5_mult_booth #(parameter AW = 34, parameter BW = 34) (
    input  [AW-1:0] a,
    input  [BW-1:0] b,
...
module am5_mult_shift_add_csla #(parameter AW = 34, parameter BW = 34) (
    input  [AW-1:0] a,
    input  [BW-1:0] b,
    output [AW+BW-1:0] product
);
...
module am5_adder_rca #(parameter W = 32) (
    input  [W-1:0] a,
    input  [W-1:0] b,
    input          cin,
    output [W-1:0] sum,
...
module am5_adder_csla #(parameter W = 32) (
    input  [W-1:0] a,
    input  [W-1:0] b,
    input          cin,
    output [W-1:0] sum,
...
module am5_adder_cla #(parameter W = 32) (
    input  [W-1:0] a,
    input  [W-1:0] b,
    input          cin,
    output [W-1:0] sum,
